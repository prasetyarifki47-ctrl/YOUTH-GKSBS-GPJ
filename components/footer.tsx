  ...
  return (
    <footer className="bg-[#654734] text-white">
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:px-10 lg:px-16">
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-[1.2fr_0.7fr_1.3fr]">
          ...
          <div>
            ...
            <p className="mt-5 max-w-md text-sm leading-7 text-[#E7DED6]">
          ...
          <div>
            ...
            <div className="mt-6 flex flex-col gap-4 text-sm text-[#E7DED6]">
          ...
          <div>
            ...
            <div className="mt-6 space-y-5 text-sm text-[#E7DED6]">
              ...
              >
                ...
                <span className="mt-0.5 shrink-0 text-[#C7B69C]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              >
                ...
                <span className="mt-0.5 shrink-0 text-[#C7B69C]">
                  <svg
                    ...
                    className="h-5 w-5"
                  >
                    <path d="M20.52 3.48A11.87 11.87 0 0 0 12.05 0C5.5 0 .17 5.33.17 11.88c0 2.09.55 4.13 1.59 5.93L.1 24l6.34-1.66a11.84 11.84 0 0 0 5.61 1.43h.01c6.55 0 11.88-5.33 11.88-11.88 0-3.17-1.23-6.15-3.42-8.41ZM12.06 21.77h-.01a9.84 9.84 0 0 1-5.02-1.37l-.36-.21-3.76.98 1-3.67-.23-.38a9.87 9.87 0 1 1 8.38 4.65Zm5.42-7.39c-.3-.15-1.77-.87-2.05-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.94 1.17-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.48-.89-.79-1.49-1.77-1.66-2.07-.17-.3-.02-.46.13-.61.14-.14.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.07-.15-.67-1.61-.92-2.2-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.79.37-.27.3-1.04 1.02-1.04 2.49s1.07 2.89 1.22 3.09c.15.2 2.1 3.21 5.09 4.5.71.31 1.26.49 1.69.63.71.23 1.35.2 1.86.12.57-.09 1.77-.72 2.02-1.42.25-.7.25-1.3.17-1.42-.07-.12-.27-.2-.57-.35Z" />
                  </svg>
                </span>
