    ...
    <main className="min-h-screen bg-[#F7F3EC] text-[#2E2A26]">
      ...
      <section className="px-6 pb-20 pt-36 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mb-5 text-sm font-medium uppercase tracking-[0.3em] text-[#8B7355]">
              1
            </p>
            ...
            <p className="mt-6 max-w-2xl text-justify text-base leading-8 text-[#6F6860] sm:text-lg">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <a
              ...
              className="group rounded-2xl border border-[#DED7CE] bg-[#F7F3EC] p-8 transition duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              ...
              <div className="flex items-start justify-between">
                ...
                <span className="text-sm text-[#8B7355] transition group-hover:translate-x-1">
                  WhatsApp →
                </span>
              ...
              <p className="mt-5 text-sm leading-7 text-[#6F6860]">
                Hubungi untuk informasi umum atau hal lain
                mengenai Youth GKSBS Gunung Pasir Jaya.
              </p>
            ...
            >
              ...
              <p className="mt-5 text-sm leading-7 text-[#6F6860]">
                Hubungi untuk informasi mengenai kegiatan,
                pelayanan, dan kepengurusan Youth GKSBS Gunung Pasir Jaya.
              </p>
            ...
            >
              ...
              <p className="mt-5 text-sm leading-7 text-[#6F6860]">
                Ikuti dokumentasi, informasi kegiatan, dan
                berbagai cerita dari perjalanan pemuda.
              </p>
            ...
            >
              ...
              <p className="mt-5 text-sm leading-7 text-[#6F6860]">
                Temukan video dan keseruan kegiatan pemuda
                melalui konten kami.
              </p>
      ...
      <section className="px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          ...
          {/* MAP CARD */}
          <div className="overflow-hidden rounded-3xl border border-[#DED7CE] bg-white shadow-sm">
            ...
            <div className="grid lg:grid-cols-[1.3fr_0.7fr]">
              ...
              <div className="flex flex-col justify-center p-8 sm:p-10">
                ...
                <p className="mt-3 text-sm leading-7 text-[#6F6860]">
                  MHP3+JJ5, Jl. Ir. Sutami, Gn. Pasir Jaya, Kec. Sekampung Udik, Kabupaten Lampung Timur, Lampung 34376, Indonesia
                </p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-7 inline-flex w-fit rounded-lg bg-[#4A3426] px-6 py-3 text-sm font-medium text-white transition duration-300 hover:bg-[#654734]"
                >
                  Buka di Google Maps
                </a>
      ...
      <section className="bg-white px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          ...
          {/* GOOGLE FORM CARD */}
          <div className="mx-auto mt-12 max-w-4xl overflow-hidden rounded-3xl border border-[#DED7CE] bg-[#F7F3EC]">
              ...
              <div className="flex items-center bg-white p-8 sm:p-10">
                ...
                <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-6 inline-flex items-center justify-center rounded-lg bg-[#4A3426] px-6 py-3.5 text-sm font-medium text-white transition duration-300 hover:bg-[#654734]"
                  >
                    Isi G-Form Aspirasi
                  </a>
      ...
      {/* =====================================================
          5 — PENUTUP
      ====================================================== */}
      <section className="relative overflow-hidden px-6 py-24 text-center text-white sm:px-10 lg:px-16">
        ...
        {/* Overlay */}
        <div className="absolute inset-0 bg-[#2E2119]/60" />
